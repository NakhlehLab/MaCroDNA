...
def func(rand_num, m_p, n_p, s_p, dna, rna, clonal_dfs, option, clus, names_dir):
    ...
    if option == "relaxed":
        model_dat = MaCroDNA_relaxed(rna, new_dna)
    else:
...
if __name__ == "__main__":
    ...
    mother_dir = "/home/mae6/Bian_scripts_data/all_props_exp_res/"
    ...
    for d in biop_sample:
        for option in options:
            for clustering_setting in clustering_settings:
                ...
                # ========= path handle =========
                tgt_dir = f"props_exp_res_{clustering_setting}_{option}_{d}/"
                ...
                processes = [pool.apply_async(func,
                    args = (k, m_p, n_p, s_p, dna, rna, clonal_dfs, option, clus, names_dir)) for k in range(N)]
